...
def hparam_schedule_alpha_beta(step, num_latent_connections, start_step=5000, alpha_duration=5000, beta_duration=10000, start_beta = 10, final_beta = 1):
...
def hparam_schedule_alpha_beta2(step, num_latent_connections, start_step=5000, alpha_duration=5000, beta_duration=5000, start_beta = 10, final_beta = 1):
