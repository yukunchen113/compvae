...
# architectures:
encoder_layers = [
	[64,1,2],["resnet",[[64,4,1],["bn"]],[[64,4,1],["bn"]]],["resnet",[[64,4,1],["bn"]],[[64,4,1],["bn"]]],
	[128,1,2],["resnet",[[128,4,1],["bn"]],[[128,4,1],["bn"]]],["resnet",[[128,4,1],["bn"]],[[128,4,1],["bn"]]],
...
decoder_layers =[
	...
	[128,4,1],[128,1,1],["resnet",[[128,4,1],["bn"]],[[128,4,1],["bn"]]],["resnet",[[128,4,1],["bn"]],[[128,4,1],["bn"]]],
...
encoder_activations = {"default":tf.nn.leaky_relu,
	...
	6:tf.keras.activations.linear, # projection layer
	-1:tf.keras.activations.linear}
decoder_activations = {"default":tf.nn.leaky_relu, 
	1:tf.keras.activations.linear, # projection layer
	4:tf.keras.activations.linear, # projection layer for concat with encoder
	8:tf.keras.activations.linear, # projection layer for concat with encoder
	-1:tf.math.sigmoid}
ladder_connections = [(2,-3),(5,-7)]# (encoder output, decoder input)
